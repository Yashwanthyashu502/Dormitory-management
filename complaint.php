...
<h1 class="display-1 text-danger text-center text-uppercase mb-2">Enter Student Complaint Details</h1>
...
<div class="row justify-content-center">
    <form class="col-lg-8 col-md-10 col-sm-12 shadow-lg p-3" action="cphp.php" method="post">
        <div class="form group">
            ...
            <div class="form group">
            <label for="stu_name">Parents phone number</label>
            <input type="phone"name="phone" placeholder="contact" class="form-control" pattern="[1-9]{1}[0-9]{9}" title="Input format is only upto 10 digit numbers" required>
            <div class="form group">
            <label for="complaint">Complaint</label>
            <textarea name="complaint" class="form-control" required placeholder="Student complaint here"></textarea>
        </div>
